...
!function($) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown menu">' +
                ...
                '<div class="ranges">' +
                '<div class="ui form range_inputs">' +
                ...
                '<button class="ui small positive button applyBtn" disabled="disabled">' + this.locale.applyLabel + '</button>' +
                '<button class="ui small button clearBtn">' + this.locale.clearLabel + '</button>' +
                '</div>' +
                '</div>' +
                '</div>' +
                '</div>';
